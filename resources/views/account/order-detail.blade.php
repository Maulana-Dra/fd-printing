  ...
  <div class="max-w-4xl mx-auto px-4">
    ...
    @php
      ...
      if ($isWaitingConfirmation) {
          $sc = ['badge' => 'bg-blue-100 text-blue-800', 'dot' => 'bg-blue-400', 'ring' => 'ring-blue-300'];
      } else {
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
          ...
          <div class="relative">
            ...
            @php
              ...
              if ($isWaitingConfirmation && $isLast) {
                  $logSc = ['dot' => 'bg-blue-400'];
                  $logLabel = 'Menunggu Konfirmasi';
              } else {
                  $logSc  = $statusColors[$log->to_status->value] ?? ['dot' => 'bg-gray-400'];
                  $logLabel = $log->to_status->label();
              }
            @endphp
            <div class="flex gap-4 {{ !$isLast ? 'mb-0' : '' }}">
              ...
              <div class="pb-4 flex-1 min-w-0">
                <div class="flex flex-wrap items-baseline gap-x-2">
                  <p class="text-sm font-semibold text-gray-800">{{ $logLabel }}</p>
      ...
      <div class="lg:w-72 shrink-0 space-y-5">
        ...
        <div class="space-y-2">
          ...
          <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', config('printing.company.phone', '')) }}?text={{ urlencode('Halo, saya ingin tanya tentang pesanan ' . $order->order_number) }}"
             ...
             class="flex w-full items-center justify-center gap-2 py-2.5 bg-green-500 hover:bg-green-600 text-white font-medium rounded-xl transition text-sm">
